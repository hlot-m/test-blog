...
class CommentsFixture extends TestFixture
{
    ...
    public $fields = [
        'id_comment' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id_comment'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
